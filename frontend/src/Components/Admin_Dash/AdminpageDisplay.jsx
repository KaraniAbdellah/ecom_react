...
const ProductDisplay = ({ products, handleUpdate, handleDelete }) => {
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg mt-12 p-8">
      ...
      {products.map((prod) => (
        <div key={prod._id} className="flex items-center space-x-4 border border-gray-200 rounded-lg p-4 mb-4">
          <img
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg font-semibold text-gray-800 truncate">{prod.title} | {prod.category}</h3>
